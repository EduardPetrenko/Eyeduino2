...
Video is being catched successfully
Motors are driven by motorsWrite() function
Try to implement PD algorithm for dotted line following
Terms:
...
#define SPEED_DIFF 80.0

#define FACTOR_PROPORT 0.25
#define FACTOR_DIFF 2.0
...
void calcSpeed() {
  ...
  lSpeed=constrain(MIDDLE_SPEED+round(SPEED_DIFF*regulator),-255,255);
  rSpeed=constrain(MIDDLE_SPEED-round(SPEED_DIFF*regulator),-255,255);
}
